...
def render_html(html_str: str):
    """Clean all leading whitespace and empty lines so Streamlit CommonMark never interprets HTML as a code block."""
...
st.markdown(
    "<footer style='margin-top:40px;padding:16px 0;text-align:center;color:#94A3B8;font-size:11px;border-top:1px solid #E2E8F0;letter-spacing:0.02em;'>Prepared by Ashish</footer>",
    unsafe_allow_html=True,
)
